...
function Main() {
  ...
  return (
    ...
    >
      ...
      <Calling />
      <MessageText
        textBold="Добрый день и добро пожаловать в кОлл-центр АК «Aloqabank» !"
        text="Мы рады видеть вас и готовы оказать качественную помощь в решении всех ваших финансовых вопросов. 
